...
PROJECT_ROOT = "/home/epbot/Desktop/context-aware-multi-turn-seq2seq"
...
def bot_ui():
    ...
    with tf.Session() as sess:
        predictor = BotPredictor(sess, corpus_dir=corp_dir,
                                 result_dir=res_dir, result_file='basic-5700')
